...
plt.plot(ga, e3,'b-*',linewidth = 2.0, label = 'e3', color = "black")
plt.plot(ga, e4,'b-*',linewidth = 2.0, label = 'e4', color = "black")
plt.plot(ga, e5,'b-*',linewidth = 2.0, label = 'e5', color = "black")
plt.plot(ga, e6,'b-*',linewidth = 2.0, label = 'e6', color = "black")
